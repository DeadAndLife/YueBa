...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    rearVC.view.backgroundColor = [UIColor grayColor];
    
    UIViewController *frontVC = [[UIViewController alloc] init];
    frontVC.view.backgroundColor = [UIColor greenColor];
    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:frontVC];
    SiderslipVC *sider = [[SiderslipVC alloc] initWithRearVC:rearVC FrontVC:nav];
